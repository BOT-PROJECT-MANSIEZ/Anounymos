...
DEFAULT_START = ("Hey! Saya bot ANONYMOUS CHAT By Tentang Aku Dan dia.\n\n"
  ...
  try:
    if '/start' in event.raw_text:
      ...
      await client.send_message(event.chat_id,
                                message=START_TEXT,
                                buttons=[[Button.url("By","https://t.me/petercord"),
                                         Button.url("Support Channel","https://t.me/joinchat/PHzsLq6L_mlmMDQ1")]])                                                                
